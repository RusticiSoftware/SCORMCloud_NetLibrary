...
From Package Manager:
    ...
    Install-Package RusticiSoftware.HostedEngine.Client -Version 1.6.6

From .NET CLI:

    dotnet add package RusticiSoftware.HostedEngine.Client --version 1.6.6
...
[2]: https://www.nuget.org/packages/RusticiSoftware.HostedEngine.Client/1.6.6
